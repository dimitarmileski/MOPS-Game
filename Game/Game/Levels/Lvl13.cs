...
namespace Game.Levels
{
    public partial class Lvl13 : Form
    {
        ...
        {
            InitializeComponent();
            backgroundSound.SoundLocation = "Spring Village.wav";
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (isWin == true)
            {
                ...
                win.Play();
                //Win Animation 
                GameOver.Image = Image.FromFile("lvl13Win.gif");
                GameOver.Location = new Point(this.Width / 2 - (GameOver.Width / 2), this.Height / 2 - (GameOver.Height / 2));
                GameOver.Visible = true;
                //
            ...
            if (enmy1.Right > block0.Right)
            {
                ...
                check_enemy1 = false;
                enmy1.Image = Image.FromFile("whaleLeft.gif");
            ...
            if (enmy1.Left < block0.Left)
            {
                ...
                check_enemy1 = true;
                enmy1.Image = Image.FromFile("whaleRight.gif");
            }
            ...
            if (enmy2.Right > block2.Right)
            {
                ...
                check_enemy2 = false;
                enmy2.Image = Image.FromFile("whaleLeft.gif");
            }
            if (enmy2.Left < block2.Left)
            {
                enmy2.Left = block2.Left;
                check_enemy2 = true;
                enmy2.Image = Image.FromFile("whaleRight.gif");
            }
            ...
            if (enmy3.Right > block3.Right)
            {
                ...
                check_enemy3 = false;
                enmy3.Image = Image.FromFile("bigLeft.gif");
            }
            if (enmy3.Left < block3.Left)
            {
                enmy3.Left = block3.Left;
                check_enemy3 = true;
                enmy3.Image = Image.FromFile("bigRight.gif");
            }
            ...
            if (enmy4.Right > block4.Right)
            {
                ...
                check_enemy4 = false;
                enmy4.Image = Image.FromFile("captainLeft.gif");
            }
            if (enmy4.Left < block4.Left)
            {
                enmy4.Left = block4.Left;
                check_enemy4 = true;
                enmy4.Image = Image.FromFile("captainRight.gif");
            }
            ...
            if (enmy5.Right > block5.Right)
            {
                ...
                check_enemy5 = false;
                enmy5.Image = Image.FromFile("pirateLeft.gif");
            }
            if (enmy5.Left < block5.Left)
            {
                enmy5.Left = block5.Left;
                check_enemy5 = true;
                enmy5.Image = Image.FromFile("pirateRight.gif");
            }
        ...
        private void Lvl13_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl13_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl13_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Down:
