...
namespace Game.Levels
{
    public partial class Lvl14 : Form
    {
        ...
        {
            InitializeComponent();
            backgroundSound.SoundLocation = "Voices From Earth.wav";
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (isWin == true)
            {
                ...
                win.Play();
                //Win Animation 
                GameOver.Image = Image.FromFile("lvl14Win.gif");
                GameOver.Location = new Point(this.Width / 2 - (GameOver.Width / 2), this.Height / 2 - (GameOver.Height / 2));
                GameOver.Visible = true;
                //
            ...
            if (enmy1.Right > block0.Right)
            {
                ...
                check_enemy1 = false;
                enmy1.Image = Image.FromFile("greenDinoLeft.gif");
            }
            if (enmy1.Left < block0.Left)
            {
                enmy1.Left = block0.Left;
                check_enemy1 = true;
                enmy1.Image = Image.FromFile("greenDinoRight.gif");
            }
            ...
            if (enmy4.Right > block4.Right)
            {
                ...
                check_enemy4 = false;
                enmy4.Image = Image.FromFile("cucumberLeft.gif");
            }
            if (enmy4.Left < block4.Left)
            {
                enmy4.Left = block4.Left;
                check_enemy4 = true;
                enmy4.Image = Image.FromFile("cucumberRight.gif");
            }
        ...
        private void Lvl14_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl14_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl14_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Down:
