...
namespace Game.Levels
{
    public partial class Lvl8 : Form
    {
        ...
        {
            InitializeComponent();
            backgroundSound.SoundLocation = "Lyonesse.wav";
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (enmy2.Right > block2.Right)
            {
                ...
                check_enemy2 = false;
                enmy2.Image = Image.FromFile("bigLeft.gif");
            }
            if (enmy2.Left < block2.Left)
            {
                enmy2.Left = block2.Left;
                check_enemy2 = true;
                enmy2.Image = Image.FromFile("bigRight.gif");
            }
            ...
            if (enmy3.Right > block3.Right)
            {
                ...
                check_enemy3 = false;
                enmy3.Image = Image.FromFile("captainLeft.gif");
            }
            if (enmy3.Left < block3.Left)
            {
                enmy3.Left = block3.Left;
                check_enemy3 = true;
                enmy3.Image = Image.FromFile("captainRight.gif");
            }
        ...
        private void Lvl8_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Down:
