...
namespace Game.Levels
{
    public partial class Lvl9 : Form
    {
        ...
        {
            InitializeComponent();
            backgroundSound.SoundLocation = "No Place For Straw Cowboys.wav";
        ...
        private void initPositions()
        {
            ...
            enmy6.Location = new Point(block6.Location.X / 2, block6.Location.Y - enmy6.Height);
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (isWin == true)
            {
                ...
                win.Play();
                //Win Animation 
                GameOver.Image = Image.FromFile("lvl9Win.gif");
                GameOver.Location = new Point(this.Width / 2 - (GameOver.Width / 2), this.Height / 2 - (GameOver.Height / 2));
                GameOver.Visible = true;
                //
            ...
            if (enmy1.Right > block0.Right)
            {
                ...
                check_enemy1 = false;
                enmy1.Image = Image.FromFile("batLeft.gif");
            }
            if (enmy1.Left < block0.Left)
            {
                enmy1.Left = block0.Left;
                check_enemy1 = true;
                enmy1.Image = Image.FromFile("batRight.gif");
            }
            ...
            if (enmy2.Right > block2.Right)
            {
                ...
                check_enemy2 = false;
                enmy2.Image = Image.FromFile("skeletonLeft.gif");
            }
            if (enmy2.Left < block2.Left)
            {
                enmy2.Left = block2.Left;
                check_enemy2 = true;
                enmy2.Image = Image.FromFile("skeletonRight.gif");
            }
            ...
            if (enmy3.Right > block3.Right)
            {
                ...
                check_enemy3 = false;
                enmy3.Image = Image.FromFile("batLeft.gif");
            }
            if (enmy3.Left < block3.Left)
            {
                enmy3.Left = block3.Left;
                check_enemy3 = true;
                enmy3.Image = Image.FromFile("batRight.gif");
            }
            ...
            if (enmy4.Right > block4.Right)
            {
                ...
                check_enemy4 = false;
                enmy4.Image = Image.FromFile("skeletonLeft.gif");
            }
            if (enmy4.Left < block4.Left)
            {
                enmy4.Left = block4.Left;
                check_enemy4 = true;
                enmy4.Image = Image.FromFile("skeletonRight.gif");
            }
            ...
            if (enmy5.Right > block5.Right)
            {
                ...
                check_enemy5 = false;
                enmy5.Image = Image.FromFile("batLeft.gif");
            }
            if (enmy5.Left < block5.Left)
            {
                enmy5.Left = block5.Left;
                check_enemy5 = true;
                enmy5.Image = Image.FromFile("batRight.gif");
            }
            ...
            //collision with enmy5 (game over)
            ...
            //enmy6 movement and wall collision
            if (enmy6.Right > block6.Right)
            {
                enmy6.Left = block6.Right - enmy6.Width;
                check_enemy6 = false;
                enmy6.Image = Image.FromFile("skeletonLeft.gif");
            }
            if (enmy6.Left < block6.Left)
            {
                enmy6.Left = block6.Left;
                check_enemy6 = true;
                enmy6.Image = Image.FromFile("skeletonRight.gif");
            }

            if (check_enemy6 == false) { enmy6.Left += 4; }

            else { enmy6.Left -= 4; }

            //collision with enmy5 (game over)
            if (player.Right > enmy6.Left && player.Left < enmy6.Right - player.Width && player.Bottom < enmy6.Bottom && player.Bottom > enmy6.Top)
            {
                isCatched = true;
            }

            if (player.Left < enmy6.Right && player.Right > enmy6.Left + player.Width && player.Bottom < enmy6.Bottom && player.Bottom > enmy6.Top)
            {
        ...
        private void Lvl9_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl9_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl9_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Down:
