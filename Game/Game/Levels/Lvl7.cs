    ...
    public partial class Lvl7 : Form
    {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (isWin == true)
            {
                ...
                win.Play();
                //Win Animation 
                GameOver.Image = Image.FromFile("lvl7Win.gif");
                GameOver.Location = new Point(this.Width / 2 - (GameOver.Width / 2), this.Height / 2 - (GameOver.Height / 2));
                GameOver.Visible = true;
                //
            ...
            if (enmy1.Right > block0.Right)
            {
                ...
                check_enemy1 = false;
                enmy1.Image = Image.FromFile("boyLeft.gif");
            }
            if (enmy1.Left < block0.Left)
            {
                enmy1.Left = block0.Left;
                check_enemy1 = true;
                enmy1.Image = Image.FromFile("boyRight.gif");
            }
            ...
            if (enmy2.Right > block2.Right)
            {
                ...
                check_enemy2 = false;
                enmy2.Image = Image.FromFile("greenHatLeft.gif");
            }
            if (enmy2.Left < block2.Left)
            {
                enmy2.Left = block2.Left;
                check_enemy2 = true;
                enmy2.Image = Image.FromFile("greenHatRight.gif");
            }
            ...
            if (enmy3.Right > block3.Right)
            {
                ...
                check_enemy3 = false;
                enmy3.Image = Image.FromFile("boyLeft.gif");
            }
            if (enmy3.Left < block3.Left)
            {
                enmy3.Left = block3.Left;
                check_enemy3 = true;
                enmy3.Image = Image.FromFile("boyRight.gif");
            }
            ...
            if (enmy3.Right > block3.Right)
            {
                enmy3.Left = block3.Right - enmy3.Width;
                check_enemy3 = false;
                enmy3.Image = Image.FromFile("greenHatLeft.gif");
            }
            if (enmy3.Left < block3.Left)
            {
                enmy3.Left = block3.Left;
                check_enemy3 = true;
                enmy3.Image = Image.FromFile("greenHatRight.gif");
            }
            ...
            if (enmy4.Right > block4.Right)
            {
                ...
                check_enemy4 = false;
                enmy4.Image = Image.FromFile("greenHatLeft.gif");
            }
            if (enmy4.Left < block4.Left)
            {
                enmy4.Left = block4.Left;
                check_enemy4 = true;
                enmy4.Image = Image.FromFile("greenHatRight.gif");
            }
            ...
            if (enmy5.Right > block5.Right)
            {
                ...
                check_enemy5 = false;
                enmy5.Image = Image.FromFile("boyLeft.gif");
            }
            if (enmy5.Left < block5.Left)
            {
                enmy5.Left = block5.Left;
                check_enemy5 = true;
                enmy5.Image = Image.FromFile("boyRight.gif");
            }
        ...
        private void Lvl7_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl7_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl7_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Down:
