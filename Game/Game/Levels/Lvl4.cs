...
namespace Game.Levels
{
    public partial class Lvl4 : Form
    {
        ...
        {
            InitializeComponent();
            backgroundSound.SoundLocation = "Goliath's Foe.wav";
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (isWin == true)
            {
                ...
                win.Play();
                //Win Animation 
                GameOver.Image = Image.FromFile("lvl4Win.gif");
                GameOver.Location = new Point(this.Width / 2 - (GameOver.Width / 2), this.Height / 2 - (GameOver.Height / 2));
                GameOver.Visible = true;
                //
            ...
            if (enmy1.Right > block0.Right)
            {
                ...
                check_enemy1 = false;
                enmy1.Image = Image.FromFile("blueDinoLeft.gif");
            }
            if (enmy1.Left < block0.Left)
            {
                enmy1.Left = block0.Left;
                check_enemy1 = true;
                enmy1.Image = Image.FromFile("blueDinoRight.gif");
            }
            ...
            if (enmy2.Right > block2.Right)
            {
                ...
                check_enemy2 = false;
                enmy2.Image = Image.FromFile("redDinoLeft.gif");
            }
            if (enmy2.Left < block2.Left)
            {
                enmy2.Left = block2.Left;
                check_enemy2 = true;
                enmy2.Image = Image.FromFile("redDinoRight.gif");
            }
            ...
            if (enmy3.Right > block3.Right)
            {
                ...
                check_enemy3 = false;
                enmy3.Image = Image.FromFile("greenDinoLeft.gif");
            }
            if (enmy3.Left < block3.Left)
            {
                enmy3.Left = block3.Left;
                check_enemy3 = true;
                enmy3.Image = Image.FromFile("greenDinoRight.gif");
            }
            ...
            if (enmy4.Right > block4.Right)
            {
                ...
                check_enemy4 = false;
                enmy4.Image = Image.FromFile("blueDinoLeft.gif");
            }
        ...
        private void Lvl4_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl4_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Down:
