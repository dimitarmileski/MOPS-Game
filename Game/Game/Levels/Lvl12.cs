    ...
    public partial class Lvl12 : Form
    {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (isWin == true)
            {
                ...
                win.Play();
                //Win Animation 
                GameOver.Image = Image.FromFile("lvl12Win.gif");
                GameOver.Location = new Point(this.Width / 2 - (GameOver.Width / 2), this.Height / 2 - (GameOver.Height / 2));
                GameOver.Visible = true;
                //
        ...
        private void Lvl12_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl12_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void Lvl12_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Down:
